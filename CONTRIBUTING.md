...
To contribute, head to [github](https://github.com/Insomniiak/KubePloy).
...
**2** - Each Pull Request should have its own issue created and referenced in every commit. All branches
   ...
   (saying the issue number is 42) `feature/KP-42-add-reducer`. The github pull request title should be
   named `Resolve KP #42 "[Option] Add namespace option"` and should contain `Resolve KP #42` in the description,
...
```
   ...
   **ISSUE_REFERENCE**: `KP #42` would be the issue reference of the example above.
